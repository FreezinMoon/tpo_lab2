...
import main.java.modules.trig.stub.CosModuleStub;
...
public class Step1_IntegrateSin {
    ...
    public static PiecewiseFunction createSystem() {
        ...
        return new PiecewiseFunction(
                tanStub, cotStub, secStub,
                log2Stub, log3Stub, log5Stub, lnStub
        );
    }
}
